...
public class DirectivosDTO {
	...
	public DirectivosDTO(int intCodigoDirectivo, String strNombreDirectivo,
	...
	public DirectivosDTO(int intCodigoDirectivo, String strPresideJunta) {
